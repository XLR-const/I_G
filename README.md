...
<table align="center" width="100%">
  ...
  <tr>
    <!-- Сравнение голого рендеринга и финального сглаженного кадра -->
...
Для создания густой atmosphere заброшенных бункеров в модуле `rendering/flashlight.py` реализована маска темноты визора шлема:
